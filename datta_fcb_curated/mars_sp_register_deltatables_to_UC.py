...
dlt_table_list = ['CUSTOM_UC_MARS_BPS_NEW', 'CUSTOM_UC_MARS_BPS_REVERSAL', 'CUSTOM_UC_MARS_NA_ALLOCATION', 'CUSTOM_UC_MARS_C1_MAPPING', 'CUSTOM_UC_MARS_MANUAL_MARGIN_EXPLANATION', 'CUSTOM_UC_MARS_MARGIN_BUCKET_COLLECTION', 'CUSTOM_UC_MARS_BIO_PREMIA', 'CUSTOM_UC_MARS_LOGISTICS_TFP', 'CUSTOM_UC_MARS_PURCHASE_CSO', 'CUSTOM_UC_MARS_MASTER_PLANT', 'CUSTOM_UC_MARS_MASTER_MATERIAL', 'CUSTOM_UC_MARS_MASTER_MVT_TYPE', 'CUSTOM_UC_MARS_MASTER_ACCOUNTS', 'CUSTOM_UC_MARS_MASTER_FA', 'CUSTOM_UC_MARS_C3_ITEMS', 'CUSTOM_UC_MARS_STOCK_PRICE_EFFECT', 'CUSTOM_UC_MARS_SALES_FOR_LOGISTICS', 'CUSTOM_UC_MARS_BIO_TFP_MANDATE', 'CUSTOM_UC_MARS_BEHG_TFP_STEP1','CUSTOM_UC_MARS_BEHG_ACCRUAL','CUSTOM_UC_MARS_108A_TFP']

print("creating CURATED tables in UC for MARS SP files")
